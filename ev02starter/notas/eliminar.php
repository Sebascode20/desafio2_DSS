...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['id_notas'])) {
    $id = $_POST['id_notas'];
    $url = "http://localhost/desafio2_DSS/ev02starter/notas/api/eliminar.php?id_notas=" . $id;
...
$id = $_GET['id_notas'];
$url = "http://localhost/desafio2_DSS/ev02starter/notas/api/obtener.php?id_notas=" . $id;
